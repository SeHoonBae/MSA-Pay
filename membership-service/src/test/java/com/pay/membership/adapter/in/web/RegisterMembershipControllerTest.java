...
public class RegisterMembershipControllerTest {
    ...
    public void testRegisterMembership() throws Exception{
        RegisterMembershipRequest request = new RegisterMembershipRequest("shbae", "shbae@naver.com", "seoul", true);

        Membership expect = Membership.generateMember(
                new Membership.MembershipId("1"),
                new Membership.MembershipName("shbae"),
                new Membership.MembershipEmail("shbae@naver.com"),
                new Membership.MembershipAddress("seoul"),
