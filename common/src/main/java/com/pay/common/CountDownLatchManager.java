...
public class CountDownLatchManager {
    ...
    public CountDownLatchManager(){
        ...
        // CountDownLatch(1)을 하게 되면 해당 값의 숫자(1)이 0이 될때까지 latch.await()는 영원히 멈춰있음
...
//        }
    ...
    public void addCountDownLatch(String key){this.countDownLatchMap.put(key, new CountDownLatch(1));}
